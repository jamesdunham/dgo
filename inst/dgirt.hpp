...
namespace dgirt_model_namespace {
...
class dgirt_model : public prob_grad {
private:
    int G;
    int Gl2;
    int Q;
    ...
    matrix_d l2_only;
public:
    dgirt_model(stan::io::var_context& context__,
        std::ostream* pstream__ = 0)
        : prob_grad(0) {
        current_statement_begin__ = -1;

        static const char* function__ = "dgirt_model_namespace::dgirt_model";
        ...
        pos__ = 0;
        G = vals_i__[pos__++];
        context__.validate_dims("data initialization", "Gl2", "int", context__.to_vec());
        Gl2 = int(0);
        vals_i__ = context__.vals_i("Gl2");
        pos__ = 0;
        Gl2 = vals_i__[pos__++];
        ...
        context__.validate_dims("data initialization", "NNl2", "int", context__.to_vec(T,Q,Gl2));
        validate_non_negative_index("NNl2", "T", T);
        validate_non_negative_index("NNl2", "Q", Q);
        validate_non_negative_index("NNl2", "Gl2", Gl2);
        NNl2 = std::vector<std::vector<std::vector<int> > >(T,std::vector<std::vector<int> >(Q,std::vector<int>(Gl2,int(0))));
        vals_i__ = context__.vals_i("NNl2");
        pos__ = 0;
        size_t NNl2_limit_2__ = Gl2;
        ...
        context__.validate_dims("data initialization", "SSl2", "int", context__.to_vec(T,Q,Gl2));
        validate_non_negative_index("SSl2", "T", T);
        validate_non_negative_index("SSl2", "Q", Q);
        validate_non_negative_index("SSl2", "Gl2", Gl2);
        SSl2 = std::vector<std::vector<std::vector<int> > >(T,std::vector<std::vector<int> >(Q,std::vector<int>(Gl2,int(0))));
        vals_i__ = context__.vals_i("SSl2");
        pos__ = 0;
        size_t SSl2_limit_2__ = Gl2;
        ...
        context__.validate_dims("data initialization", "WT", "matrix_d", context__.to_vec(T,Gl2,G));
        validate_non_negative_index("WT", "T", T);
        validate_non_negative_index("WT", "Gl2", Gl2);
        validate_non_negative_index("WT", "G", G);
        WT = std::vector<matrix_d>(T,matrix_d(Gl2,G));
        vals_r__ = context__.vals_r("WT");
        pos__ = 0;
        size_t WT_m_mat_lim__ = Gl2;
        ...
        ZZ = std::vector<matrix_d>(T,matrix_d(P,H));
        ...
        ZZ_prior = std::vector<matrix_d>(T,matrix_d(P,Hprior));
        ...
        check_greater_or_equal(function__,"Gl2",Gl2,1);
...
throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        std::vector<vector_d> diff_raw(D,vector_d(Q));
        ...
        std::vector<vector_d> gamma_raw(T,vector_d(P));
        ...
        std::vector<vector_d> nu_geo(T,vector_d(H));
        ...
        std::vector<vector_d> theta_bar_raw(T,vector_d(G));
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        vector<Eigen::Matrix<T__,Eigen::Dynamic,1> > theta_bar(T, (Eigen::Matrix<T__,Eigen::Dynamic,1> (G)));
        stan::math::fill(theta_bar,DUMMY_VAR__);
        vector<Eigen::Matrix<T__,Eigen::Dynamic,1> > diff(D, (Eigen::Matrix<T__,Eigen::Dynamic,1> (Q)));
        stan::math::fill(diff,DUMMY_VAR__);
        vector<Eigen::Matrix<T__,Eigen::Dynamic,1> > kappa(D, (Eigen::Matrix<T__,Eigen::Dynamic,1> (Q)));
        stan::math::fill(kappa,DUMMY_VAR__);
        Eigen::Matrix<T__,Eigen::Dynamic,1>  disc(Q);
        (void) disc;  // dummy to suppress unused var warning
        stan::math::fill(disc,DUMMY_VAR__);
        Eigen::Matrix<T__,Eigen::Dynamic,1>  sd_item(Q);
        (void) sd_item;  // dummy to suppress unused var warning
        stan::math::fill(sd_item,DUMMY_VAR__);
        Eigen::Matrix<T__,Eigen::Dynamic,1>  var_item(Q);
        (void) var_item;  // dummy to suppress unused var warning
        stan::math::fill(var_item,DUMMY_VAR__);
        Eigen::Matrix<T__,Eigen::Dynamic,1>  var_theta(T);
        (void) var_theta;  // dummy to suppress unused var warning
        stan::math::fill(var_theta,DUMMY_VAR__);
        vector<Eigen::Matrix<T__,Eigen::Dynamic,1> > var_theta_bar_l2(T, (Eigen::Matrix<T__,Eigen::Dynamic,1> (Gl2)));
        stan::math::fill(var_theta_bar_l2,DUMMY_VAR__);
        vector<Eigen::Matrix<T__,Eigen::Dynamic,1> > gamma(T, (Eigen::Matrix<T__,Eigen::Dynamic,1> (P)));
        stan::math::fill(gamma,DUMMY_VAR__);
        vector<Eigen::Matrix<T__,Eigen::Dynamic,1> > mu_theta_bar(T, (Eigen::Matrix<T__,Eigen::Dynamic,1> (G)));
        stan::math::fill(mu_theta_bar,DUMMY_VAR__);
        vector<Eigen::Matrix<T__,Eigen::Dynamic,1> > mu_gamma(T, (Eigen::Matrix<T__,Eigen::Dynamic,1> (P)));
        stan::math::fill(mu_gamma,DUMMY_VAR__);
        vector<vector<Eigen::Matrix<T__,Eigen::Dynamic,1> > > z(T, (vector<Eigen::Matrix<T__,Eigen::Dynamic,1> >(Q, (Eigen::Matrix<T__,Eigen::Dynamic,1> (G)))));
        stan::math::fill(z,DUMMY_VAR__);
        vector<vector<Eigen::Matrix<T__,Eigen::Dynamic,1> > > z_l2(T, (vector<Eigen::Matrix<T__,Eigen::Dynamic,1> >(Q, (Eigen::Matrix<T__,Eigen::Dynamic,1> (Gl2)))));
        stan::math::fill(z_l2,DUMMY_VAR__);
        vector<vector<vector<T__> > > prob(T, (vector<vector<T__> >(Q, (vector<T__>(G)))));
        vector<vector<Eigen::Matrix<T__,Eigen::Dynamic,1> > > prob_l2(T, (vector<Eigen::Matrix<T__,Eigen::Dynamic,1> >(Q, (Eigen::Matrix<T__,Eigen::Dynamic,1> (Gl2)))));
        stan::math::fill(prob_l2,DUMMY_VAR__);
        vector<Eigen::Matrix<T__,Eigen::Dynamic,1> > theta_l2(T, (Eigen::Matrix<T__,Eigen::Dynamic,1> (Gl2)));
        ...
        try {
            ...
            for (int t = 1; t <= T; ++t) {
                ...
                for (int n = 1; n <= Gl2; ++n) {
                    {
                        Eigen::Matrix<T__,Eigen::Dynamic,Eigen::Dynamic>  WTdiag(G,G);
        ...
        try {
            {
                ...
                lp_accum__.add(cauchy_log<propto__>(sd_innov_delta, 0, 2.5));
                current_statement_begin__ = 160;
                lp_accum__.add(cauchy_log<propto__>(sd_innov_gamma, 0, 2.5));
                current_statement_begin__ = 161;
                lp_accum__.add(cauchy_log<propto__>(sd_innov_logsd, 0, 2.5));
                ...
                for (int t = 1; t <= T; ++t) {
                    ...
                    if (as_bool(logical_eq(t,1))) {
                        ...
                        lp_accum__.add(normal_log<propto__>(get_base1(delta_tbar,t,"delta_tbar",1), 0.5, 0.5));
...
throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
    ...
    void write_array(RNG& base_rng__,
        ...
        static const char* function__ = "dgirt_model_namespace::write_array";
        (void) function__; // dummy call to supress warning
        ...
        vector<vector_d> theta_bar(T, (vector_d(G)));
        vector<vector_d> diff(D, (vector_d(Q)));
        vector<vector_d> kappa(D, (vector_d(Q)));
        vector_d disc(Q);
        (void) disc;  // dummy to suppress unused var warning
        vector_d sd_item(Q);
        (void) sd_item;  // dummy to suppress unused var warning
        vector_d var_item(Q);
        (void) var_item;  // dummy to suppress unused var warning
        vector_d var_theta(T);
        (void) var_theta;  // dummy to suppress unused var warning
        vector<vector_d> var_theta_bar_l2(T, (vector_d(Gl2)));
        vector<vector_d> gamma(T, (vector_d(P)));
        vector<vector_d> mu_theta_bar(T, (vector_d(G)));
        vector<vector_d> mu_gamma(T, (vector_d(P)));
        vector<vector<vector_d> > z(T, (vector<vector_d>(Q, (vector_d(G)))));
        vector<vector<vector_d> > z_l2(T, (vector<vector_d>(Q, (vector_d(Gl2)))));
        vector<vector<vector<double> > > prob(T, (vector<vector<double> >(Q, (vector<double>(G, 0.0)))));
        vector<vector<vector_d> > prob_l2(T, (vector<vector_d>(Q, (vector_d(Gl2)))));
        vector<vector_d> theta_l2(T, (vector_d(Gl2)));
                ...
                for (int q = 1; q <= Q; ++q) {
                    {
                        double sd_tq(0.0);
                        (void) sd_tq;  // dummy to suppress unused var warning
                        vector<double> sd_l2_tq(Gl2, 0.0);
...
throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
        ...
        for (int k_1__ = 0; k_1__ < Gl2; ++k_1__) {
            for (int k_0__ = 0; k_0__ < T; ++k_0__) {
        ...
        for (int k_2__ = 0; k_2__ < Gl2; ++k_2__) {
            for (int k_1__ = 0; k_1__ < Q; ++k_1__) {
                for (int k_0__ = 0; k_0__ < T; ++k_0__) {
...
throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        for (int k_1__ = 1; k_1__ <= Gl2; ++k_1__) {
            for (int k_0__ = 1; k_0__ <= T; ++k_0__) {
                param_name_stream__.str(std::string());
        ...
        for (int k_2__ = 1; k_2__ <= Gl2; ++k_2__) {
            for (int k_1__ = 1; k_1__ <= Q; ++k_1__) {
                for (int k_0__ = 1; k_0__ <= T; ++k_0__) {
                    param_name_stream__.str(std::string());
...
typedef dgirt_model_namespace::dgirt_model stan_model;

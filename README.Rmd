...
Install `dgirt` from GitHub. `dgirt` requires [`rstan`](https://github.com/stan-dev/rstan).
[See](https://github.com/stan-dev/rstan/wiki/RStan-Getting-Started#how-to-install-rstan)

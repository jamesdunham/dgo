...
public:
    model_2015_12_16(stan::io::var_context& context__,
        ...
        WT = std::vector<matrix_d>(T,matrix_d(G_hier,G));
...
throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        vector<Eigen::Matrix<T__,Eigen::Dynamic,1> > var_theta_bar_l2(T, (Eigen::Matrix<T__,Eigen::Dynamic,1> (G_hier)));
        ...
        vector<vector<Eigen::Matrix<T__,Eigen::Dynamic,1> > > z_l2(T, (vector<Eigen::Matrix<T__,Eigen::Dynamic,1> >(Q, (Eigen::Matrix<T__,Eigen::Dynamic,1> (G_hier)))));
        stan::math::fill(z_l2,DUMMY_VAR__);
        vector<vector<vector<T__> > > prob(T, (vector<vector<T__> >(Q, (vector<T__>(G)))));
        vector<vector<Eigen::Matrix<T__,Eigen::Dynamic,1> > > prob_l2(T, (vector<Eigen::Matrix<T__,Eigen::Dynamic,1> >(Q, (Eigen::Matrix<T__,Eigen::Dynamic,1> (G_hier)))));
        stan::math::fill(prob_l2,DUMMY_VAR__);
        vector<Eigen::Matrix<T__,Eigen::Dynamic,1> > theta_l2(T, (Eigen::Matrix<T__,Eigen::Dynamic,1> (G_hier)));
...
throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
    ...
    void write_array(RNG& base_rng__,
        ...
        (void) var_theta;  // dummy to suppress unused var warning
        vector<vector_d> var_theta_bar_l2(T, (vector_d(G_hier)));
        ...
        vector<vector<vector_d> > z_l2(T, (vector<vector_d>(Q, (vector_d(G_hier)))));
        vector<vector<vector<double> > > prob(T, (vector<vector<double> >(Q, (vector<double>(G, 0.0)))));
        vector<vector<vector_d> > prob_l2(T, (vector<vector_d>(Q, (vector_d(G_hier)))));
        vector<vector_d> theta_l2(T, (vector_d(G_hier)));
